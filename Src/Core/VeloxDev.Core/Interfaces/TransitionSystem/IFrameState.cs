...
namespace VeloxDev.TransitionSystem
{
    public interface IFrameState
    {
        ...
        public ConcurrentDictionary<ITransitionProperty, ISampleable> Interpolators { get; }
        public ConcurrentDictionary<ITransitionProperty, object?> Options { get; }

        public void SetInterpolator<TSource, TValue>(Expression<Func<TSource, TValue>> expression, ISampleable interpolator);
        public void SetValue<TSource, TValue>(Expression<Func<TSource, TValue>> expression, TValue? value);
        public bool TryGetInterpolator<TSource, TValue>(Expression<Func<TSource, TValue>> expression, out ISampleable? interpolator);
        public bool TryGetValue<TSource, TValue>(Expression<Func<TSource, TValue>> expression, out TValue? value);
        public void SetInterpolator(ITransitionProperty property, ISampleable interpolator);
        public void SetValue(ITransitionProperty property, object? value);
        public bool TryGetInterpolator(ITransitionProperty property, out ISampleable? interpolator);
        public bool TryGetValue(ITransitionProperty property, out object? value);
        public void SetInterpolator(PropertyInfo propertyInfo, ISampleable interpolator);
        public void SetValue(PropertyInfo propertyInfo, object? value);
        public bool TryGetInterpolator(PropertyInfo propertyInfo, out ISampleable? interpolator);
