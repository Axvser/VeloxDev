...
/// </summary>
public sealed class TemplateClass : Canvas, IWorkflowMinimapOverlay
{
    // ── Dependency Properties ────────────────────────────────────────────────

    private static void OnPropChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        => ((TemplateClass)d).InvalidateArrange();

    public static readonly DependencyProperty ScrollOffsetXProperty =
        DependencyProperty.Register(nameof(ScrollOffsetX), typeof(double), typeof(TemplateClass), new PropertyMetadata(0d, OnPropChanged));
    public static readonly DependencyProperty ScrollOffsetYProperty =
        DependencyProperty.Register(nameof(ScrollOffsetY), typeof(double), typeof(TemplateClass), new PropertyMetadata(0d, OnPropChanged));
    public static readonly DependencyProperty ContentOffsetXProperty =
        DependencyProperty.Register(nameof(ContentOffsetX), typeof(double), typeof(TemplateClass), new PropertyMetadata(0d, OnPropChanged));
    public static readonly DependencyProperty ContentOffsetYProperty =
        DependencyProperty.Register(nameof(ContentOffsetY), typeof(double), typeof(TemplateClass), new PropertyMetadata(0d, OnPropChanged));
    public static readonly DependencyProperty ViewportWidthProperty =
        DependencyProperty.Register(nameof(ViewportWidth), typeof(double), typeof(TemplateClass), new PropertyMetadata(1d, OnPropChanged));
    public static readonly DependencyProperty ViewportHeightProperty =
        DependencyProperty.Register(nameof(ViewportHeight), typeof(double), typeof(TemplateClass), new PropertyMetadata(1d, OnPropChanged));
    public static readonly DependencyProperty WorkflowTreeProperty =
        DependencyProperty.Register(nameof(WorkflowTree), typeof(IWorkflowTreeViewModel), typeof(TemplateClass), new PropertyMetadata(null, (d, e) => ((TemplateClass)d).OnTreeChanged((IWorkflowTreeViewModel?)e.NewValue)));
    public static readonly DependencyProperty IsMinimapVisibleProperty =
        DependencyProperty.Register(nameof(IsMinimapVisible), typeof(bool), typeof(TemplateClass), new PropertyMetadata(true, OnPropChanged));
    ...
    private static readonly SolidColorBrush BackgroundBrush = CreateBrush("TemplateMinimapBackground");
    private static readonly SolidColorBrush BorderBrush = CreateBrush("TemplateMinimapBorder");
    private static readonly SolidColorBrush NodeBrush = CreateBrush("TemplateNodeFill");
    private static readonly SolidColorBrush ViewportBrush = CreateBrush("TemplateViewportStroke");
