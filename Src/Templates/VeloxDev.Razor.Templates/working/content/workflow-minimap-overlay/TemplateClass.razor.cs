...
/// <see cref="WorkflowMinimapOverlay"/> with the template's symbol-driven colors.
/// </summary>
public partial class TemplateClass : ComponentBase
{
    ...
    private string Background { get; } = ToCss("TemplateMinimapBackground");
    private string Border { get; } = ToCss("TemplateMinimapBorder");
    private string NodeFill { get; } = ToCss("TemplateNodeFill");
    private string ViewportStroke { get; } = ToCss("TemplateViewportStroke");
