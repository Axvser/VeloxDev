...
public class TemplateClass : FrameworkElement
{
    ...
    // The ruler-band reserve, kept equal to the generated GridDecorator's RulerThickness (36) so the
    ...
    private (Point FromP, Point ToP)? EndpointsCanvasLocal()
    {
        ...
        var rx = origin.Horizontal + RulerReserve;
        var ry = origin.Vertical + RulerReserve;
