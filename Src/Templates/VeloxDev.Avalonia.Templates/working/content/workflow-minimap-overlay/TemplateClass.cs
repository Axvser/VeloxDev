...
/// </summary>
public sealed class TemplateClass : Control, IWorkflowMinimapOverlay
{
    // ── Styled Properties ────────────────────────────────────────────────────
    ...
    public static readonly StyledProperty<double> ViewportWidthProperty =
        AvaloniaProperty.Register<TemplateClass, double>(nameof(ViewportWidth), 1d);
    public static readonly StyledProperty<double> ViewportHeightProperty =
        AvaloniaProperty.Register<TemplateClass, double>(nameof(ViewportHeight), 1d);
    public static readonly StyledProperty<IWorkflowTreeViewModel?> WorkflowTreeProperty =
        AvaloniaProperty.Register<TemplateClass, IWorkflowTreeViewModel?>(nameof(WorkflowTree));
    public static readonly StyledProperty<bool> IsMinimapVisibleProperty =
        AvaloniaProperty.Register<TemplateClass, bool>(nameof(IsMinimapVisible), true);
    ...
    private static readonly IBrush BackgroundBrush =
        new ImmutableSolidColorBrush(Color.Parse("TemplateMinimapBackground"));
    private static readonly Pen BorderPen = CreatePen("TemplateMinimapBorder", 1);
    private static readonly IBrush NodeBrush =
        new ImmutableSolidColorBrush(Color.Parse("TemplateNodeFill"));
