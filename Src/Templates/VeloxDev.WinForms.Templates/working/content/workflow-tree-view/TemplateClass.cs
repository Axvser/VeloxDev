...
public sealed class TemplateClass : UserControl
{
    ...
    /// the floating rulers and the world axes land on their inner corner. A screen-space translate only;
    /// canonical helper.Viewport / reported numbers still exclude it.</summary>
