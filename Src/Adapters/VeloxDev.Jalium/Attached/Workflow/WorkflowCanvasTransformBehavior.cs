...
/// WorkflowSurfaceBehavior sets this property directly; node/link views read it (via the
/// ViewManager) and apply it as their RenderTransform. The host itself must not receive it.
/// </summary>
public static class WorkflowCanvasTransformBehavior
{
    ...
    private static void OnTransformChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        // The ViewManager mirrors it onto active node/link views' RenderTransform.
    }
}
