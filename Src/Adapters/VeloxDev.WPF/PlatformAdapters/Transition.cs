...
namespace VeloxDev.TransitionSystem
{
    ...
    public class Transition<T> : TransitionCore<T, Transition<T>.StateSnapshot>
    {
            ...
            DispatcherPriority>
        {
            ...
            public StateSnapshot Property(Expression<Func<T, Vector>> propertyLambda, Vector newValue, object? interpolationOptions = null)
            {
                state.SetValue(propertyLambda, newValue);
                if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
                return this;
            ...
            public StateSnapshot Property(Expression<Func<T, DropShadowEffect?>> propertyLambda, DropShadowEffect? newValue, object? interpolationOptions = null)
            {
                state.SetValue(propertyLambda, newValue);
                if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
                return this;
            }
            public StateSnapshot Property(Expression<Func<T, Point3D>> propertyLambda, Point3D newValue, object? interpolationOptions = null)
            {
                state.SetValue(propertyLambda, newValue);
                if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
                return this;
            }
            public StateSnapshot Property(Expression<Func<T, Vector3D>> propertyLambda, Vector3D newValue, object? interpolationOptions = null)
            {
                state.SetValue(propertyLambda, newValue);
                if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
                return this;
