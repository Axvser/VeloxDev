...
namespace VeloxDev.TransitionSystem
{
        ...
        where T : class
    {
        ...
        public Transition<T> Property(Expression<Func<T, Projection?>> propertyLambda, Projection? newValue, object? interpolationOptions = null)
        {
            state.SetValue(propertyLambda, newValue);
            if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
            return this;
        ...
        public Transition<T> Property(Expression<Func<T, GridLength>> propertyLambda, GridLength newValue, object? interpolationOptions = null)
        {
            state.SetValue(propertyLambda, newValue);
            if (interpolationOptions != null) state.SetOptions(propertyLambda, interpolationOptions);
            return this;
