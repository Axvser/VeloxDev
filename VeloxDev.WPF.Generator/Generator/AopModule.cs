    ...
    public class AopModule : IIncrementalGenerator
    {
        ...
        private static void GenerateSource(SourceProductionContext context, (Compilation Compilation, ImmutableArray<ClassDeclarationSyntax> Classes) input)
        {
            foreach (var classDeclaration in input.Classes)
            {
                    ...
                    SyntaxFactory.SingletonSeparatedList<BaseTypeSyntax>(
                        SyntaxFactory.SimpleBaseType(
                            SyntaxFactory.QualifiedName(
                                SyntaxFactory.ParseName("global::VeloxDev.WPF.AspectOriented"),
                ...
                NamespaceDeclarationSyntax namespaceDeclaration = SyntaxFactory.NamespaceDeclaration(SyntaxFactory.ParseName("VeloxDev.WPF.AopInterfaces"))
