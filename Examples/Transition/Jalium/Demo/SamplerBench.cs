...
{
    private const double StageWidth = 76d;
    private const double StageHeight = 50d;
    ...
    internal FrameworkElement Build(IReadOnlyList<string> samplers)
    {
        ...
        {
            Text = "采样器演示台 — 点把手看它动；每一格显示该采样器写进控件属性的效果（载荷里始终是原值）",
            FontSize = 10,
        ...
        foreach (var sampler in samplers)
        {
            ...
            var cell = new StackPanel { Orientation = Orientation.Vertical, Margin = new Thickness(3) };
