...
internal static class SamplerProbe
{
    ...
    [
        ...
        new(Kinds.DropShadowEffectSampler, nameof(SamplerSubject.Shadow), () => new DropShadowEffectSampler(),
        ...
        new(Kinds.Point3DSampler, nameof(SamplerSubject.Anchor3D), () => new Point3DSampler(),
        ...
        new(Kinds.Vector3DSampler, nameof(SamplerSubject.Axis3D), () => new Vector3DSampler(),
            () => new Vector3D(10, 20, 30), () => new Vector3D(110, 220, 330)),
        new(Kinds.VectorSampler, nameof(SamplerSubject.Slope), () => new VectorSampler(),
    ...
    private static string Describe(object? value) => value switch
    {
        ...
        DropShadowEffect shadow
            => $"DropShadowEffect,{shadow.Color.A},{shadow.Color.R},{shadow.Color.G},{shadow.Color.B},"
             + $"{Number(shadow.Direction)},{Number(shadow.ShadowDepth)},{Number(shadow.Opacity)},{Number(shadow.BlurRadius)}",
        Point3D point3 => $"Point3D,{Number(point3.X)},{Number(point3.Y)},{Number(point3.Z)}",
        ...
        Vector3D vector3 => $"Vector3D,{Number(vector3.X)},{Number(vector3.Y)},{Number(vector3.Z)}",
        Vector vector => $"Vector,{Number(vector.X)},{Number(vector.Y)}",
