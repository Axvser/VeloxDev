...
/// <summary>
/// The Jalium end of the acceptance run: every scenario the demo's overshoot strip exposes, driven through UI
...
public class JaliumOvershootSuite
{
    /// <summary>
    ...
    private static JaliumDemoDriver? _demo;
    ...
    public static void LaunchDemo(TestContext context)
    {
        ...
        if (!AtConfig.Enabled || !AtConfig.RunsOn(JaliumDemoDriver.PlatformName)) return;

        _demo = new JaliumDemoDriver();
        _demo.Launch();
    }
    ...
    [TestMethod]
    public void Jalium_Back_OvershootsAndSettlesExactly() => AssertScalar(ScenarioId.Back);

    /// <summary>A translate on X under <c>Elastic.Out</c>.</summary>
    [TestMethod]
    public void Jalium_Elastic_OvershootsAndSettlesExactly() => AssertScalar(ScenarioId.Elastic);

    /// <summary>A width under <c>Elastic.Out</c>, the second scalar the payload tracks a peak for.</summary>
    [TestMethod]
    public void Jalium_Size_OvershootsAndSettlesExactly() => AssertScalar(ScenarioId.Size);
    ...
    /// </summary>
    [TestMethod]
    public void Jalium_Color_OvershootsOnEveryChannelAndSettlesExactly()
    {
    ...
    /// </summary>
    [TestMethod]
    public void Jalium_Brush_StaysNonSolidThroughoutAndSettles()
    {
        DemoCatalog.RequireEnabled(JaliumDemoDriver.PlatformName);
        var driver = Demo();
    ...
    /// </summary>
    [TestMethod]
    public void Jalium_Elastic_EveryRepeatedRunClearsItsBound()
    {
        DemoCatalog.RequireEnabled(JaliumDemoDriver.PlatformName);
        var driver = Demo();
    ...
    private static JaliumDemoDriver Demo() => _demo
        ?? throw new InvalidOperationException(
            $"{JaliumDemoDriver.PlatformName} was not launched. VELOXDEV_AT is set, so the demo build or its path is the problem.");
