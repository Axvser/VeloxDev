...
/// ScrollOffset/ContentOffset/Viewport DPs that the host binds (same feed as the minimap), and from the
/// surface's own ViewChanged. The 复制 button copies the current multi-line info to the clipboard.
/// </summary>
