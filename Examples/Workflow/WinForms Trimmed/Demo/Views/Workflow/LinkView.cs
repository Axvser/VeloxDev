...
// alias keeps `new Size(...)` usage unambiguous.
...
public sealed class LinkView : Control
{
    ...
    private float _thickness = float.Parse("2", CultureInfo.InvariantCulture);
    ...
    private void RebuildGeometry()
    {
        ...
        // is null, e.g. the VirtualLink gesture) are exempt.
