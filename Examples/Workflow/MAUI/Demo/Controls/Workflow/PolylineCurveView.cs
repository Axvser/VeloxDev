...
public sealed class PolylineCurveView : GraphicsView
{
    ...
    private (double X, double Y) GetCanvasOffset()
    {
        ...
        // WinUI binding exceptions.  Matches WPF/Avalonia/WinUI pattern
        // where the link view resolves the offset internally.
    ...
    private sealed class PolylineDrawable(PolylineCurveView owner) : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            // Resolve canvas offset on every draw.  No need for external
            // ContentOffsetX/Y updates — the link view self-resolves.
