...
namespace VeloxDev.WPF.Tools.SolidColor
{
    ...
    /// <para>Core</para>
    /// <para>- <see cref="RGB.R"/> → Red</para>
    /// <para>- <see cref="RGB.G"/> → Green</para>
    /// <para>- <see cref="RGB.B"/> → Blue</para>
    /// <para>- <see cref="RGB.A"/> → [ Int number ] representation of the Alpha</para>
    /// <para>- <see cref="RGB.Opacity"/> → [ Floating-point number ] representation of the Alpha</para>
    /// <para>- <see cref="RGB.Brush"/> → Converted to Brush</para>
    /// <para>- <see cref="RGB.SolidColorBrush"/> → Converted to SolidColorBrush</para>
    /// <para>- <see cref="RGB.Color"/> → Converted to Color</para>
    /// <para>Helper</para>
    /// <para>- <see cref="RGB.FromBrush(System.Windows.Media.Brush)"/></para>
    /// <para>- <see cref="RGB.FromColor(System.Windows.Media.Color)"/></para>
    /// <para>- <see cref="RGB.FromString(string)"/></para>
    /// <para>- <see cref="RGB.Interpolate"/></para>
    /// </summary>
