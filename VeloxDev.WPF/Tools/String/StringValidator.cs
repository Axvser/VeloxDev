namespace VeloxDev.WPF.Tools.String
{
    ...
    /// <para>Core</para>
    /// <para>- <see cref="AddRule(Func{string, bool})"/></para>
    /// <para>- <see cref="Validate(string)"/></para>
    /// <para>Helper</para>
    /// <para>- <see cref="StartWith(string, bool)"/></para>
    /// <para>- <see cref="EndWith(string, bool)"/></para>
    /// <para>- <see cref="VarLength(int, int)"/></para>
    /// <para>- <see cref="FixLength(int)"/></para>
    /// <para>- <see cref="Include(bool, string[])"/></para>
    /// <para>- <see cref="Exclude(bool, string[])"/></para>
    /// <para>- <see cref="Slice(int, string, bool)"/></para>
    /// <para>- <see cref="Regex(string)"/></para>
    /// <para>- <see cref="OnlyNumbers()"/></para>
    /// <para>- <see cref="OnlyWords()"/></para>
    /// </summary>
